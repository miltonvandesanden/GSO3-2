...
public class TimeSpan implements ITimeSpan {
    ...
    public ITimeSpan unionWith(ITimeSpan timeSpan) {
        //int een = bt.compareTo(timeSpan.getEndTime());
        //int twee = et.compareTo(timeSpan.getBeginTime());
    ...
    {
        return "bt: " + bt.toString() + " - et: " + et.toString();
    }*/
    
    @Override
    public boolean equals(Object other)
    {
        TimeSpan other2 = (TimeSpan) other;
        
        if(!this.bt.equals(other2.getBeginTime()))
        {
            return false;
        }
        
        if(!this.et.equals(other2.getEndTime()))
        {
            return false;
        }
