...
public class Money implements Serializable, Comparable<Money>
{
    ...
    */
    ...
    public static Money difference(Money m1, Money m2)
    {
        ...
        {
            throw new RuntimeException("munteenheden in aanroep 'difference' ongelijk, te weten: " + m1.currency + " en " + m2.currency);
        }
    ...
    public static Money sum(Money m1, Money m2)
    {
        if (!m1.currency.equals(m2.currency))
        {
            throw new RuntimeException("munteenheden in aanroep 'sum' ongelijk, te weten: " + m1.currency + " en " + m2.currency);
        }
